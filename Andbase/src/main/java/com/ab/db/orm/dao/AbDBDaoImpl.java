...
public class AbDBDaoImpl<T> extends AbBasicDBDao implements AbDBDao<T> {
	 ...
	 * @param clazz  返回的对象类型
	 * @return the list
	 * @see AbDBDao#rawQuery(String, String[])
	 */
	@Override
	 ...
	 * @see AbDBDao#isExist(String, String[])
	 */
	@Override
	 ...
	 * @return the list
	 * @see AbDBDao#queryList(String[], String, String[], String, String, String, String)
	 */
	@Override
     ...
     * @param selectionArgs the selection args
     * @return the list
     * @see AbDBDao#queryList(String, String[])
     * @author: amsoft.cn
     */
	@Override
	 ...
	 * 描述：插入实体.
	 * @param entity the entity
	 * @param flag the flag true:id自增 false:id指定
	 * @return the long
	 * @see AbDBDao#insert(Object, boolean)
	 */
	@Override
	 ...
	 * @param flag the flag
	 * @return the long[] 插入成功的数据ID
	 * @see AbDBDao#insertList(List, boolean)
	 */
	@Override
	 ...
	 * @return the int
	 * @see AbDBDao#delete(String, String[])
	 */
	@Override
	 ...
	 * @param selectionArgs the selection args
	 * @return the list
	 * @see AbDBDao#queryMapList(String, String[])
	 */
	@Override
	 ...
	 * @param selectionArgs the selection args
	 * @return the int
	 * @see AbDBDao#queryCount(String, String[])
	 */
	@Override
	 ...
	 * @param sql the sql
	 * @param selectionArgs the selection args
	 * @see AbDBDao#execSql(String, Object[])
	 */
	@Override
