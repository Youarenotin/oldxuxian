 ...
 * 描述:类似新浪微博下拉刷新风格
 */
public class XuXianNormalRefreshViewHolder extends XuXianRefreshViewHolder {
     ...
     */
    public XuXianNormalRefreshViewHolder(Context context, boolean isLoadingMoreEnabled) {
