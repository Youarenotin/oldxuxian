package com.xuxian.marketpro.presentation.View.listview;
...
public class ShoppingCarListView extends ListView {
    public ShoppingCarListView(Context context) {
        super(context);
    }
    //-- inner classes
    ...
    //-- constructors
    public ShoppingCarListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public ShoppingCarListView(Context context, AttributeSet attrs, int defStyle) {
    ...
    void createPinnedShadow(int position) {
        ...
        View pinnedView = getAdapter().getView(position, pinnedShadow.view, ShoppingCarListView.this);
