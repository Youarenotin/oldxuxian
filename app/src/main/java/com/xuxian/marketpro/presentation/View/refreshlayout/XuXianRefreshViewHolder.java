 ...
 */
public abstract class XuXianRefreshViewHolder {
    /**
     ...
     * 下拉刷新上拉加载更多控件
     */
    protected XuXianRefreshLayout mRefreshLayout;
    /**
     * 下拉刷新控件
     */
     ...
     */
    public XuXianRefreshViewHolder(Context context, boolean isLoadingMoreEnabled) {
        mContext = context;
     ...
     * @param refreshLayout
     */
    public void setRefreshLayout(XuXianRefreshLayout refreshLayout) {
